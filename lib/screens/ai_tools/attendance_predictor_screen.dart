...
class AttendancePredictorScreen extends StatelessWidget {
  const AttendancePredictorScreen({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          ...students
              .map((student) => _StudentAbsenceTile(student: student))
              .toList(),
        ],
      ),
    );
...
class _StudentAbsenceTile extends StatelessWidget {
  ...
  const _StudentAbsenceTile({required this.student, Key? key})
      : super(key: key);
