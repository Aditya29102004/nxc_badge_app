...
import 'support3.dart'; // Make sure the path is correct

class Support2Page extends StatelessWidget {
  const Support2Page({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFaqTile(
              ...
              ['Step 1: Go to settings.', 'Step 2: Tap on "Account".', 'Step 3: Select "Reset Password".'],
            ),
            const SizedBox(height: 8),
            _buildFaqTile(
              'How to update account details?',
              ['Step 1: Go to Profile.', 'Step 2: Tap "Edit Profile".', 'Step 3: Save your changes.'],
            ),
            const SizedBox(height: 8),
            _buildFaqTile(
              'Where can I find my invoices?',
              ['Step 1: Go to "Billing".', 'Step 2: Tap "Invoices".', 'Step 3: Download your invoice.'],
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const Support3Page()),
                  );
                },
