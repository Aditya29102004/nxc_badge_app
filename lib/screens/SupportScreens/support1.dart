...
import 'support2.dart'; // Make sure the path is correct

class Support1Page extends StatelessWidget {
  const Support1Page({Key? key}) : super(key: key);
                ...
                children: [
                  Row(
                    children: [
                      const CircleAvatar(
                        radius: 24,
                        backgroundImage: AssetImage('assets/profile_avatar.png'), // Replace with actual image path
                      ),
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const Support2Page()),
                        );
                      },
